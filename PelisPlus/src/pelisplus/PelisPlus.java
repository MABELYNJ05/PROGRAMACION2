                ...
                switch (opcion) {
                    ...
                    case 2:
                        ...
                        for (int i = 0; i < opcion; i++) {            
                            ...
                            catalogoPeli.agregarPelicula(nombre, enero, febrero, marzo, total, promedio, nombreArchivo);
                    ...
                    case 3:
                        ...
                        opn=scanner.nextInt();
                        catalogoPeli.numMaxMes(opn, nombreArchivo);
                        break;
                    case 4:
                        System.out.println("\n\t\t\t¿Que mes desea consultar?");
                        System.out.println("\n\n\t1. ENERO");
                        ...
                        opc=scanner.nextInt();  
                        catalogoPeli.numMinMes(opc, nombreArchivo);
                        break;       
                    case 5:
                        catalogoPeli.numMaxTotal(nombreArchivo);
                        break;
                    case 6:
                        //3. listar catalogo completo
                        catalogoPeli.listar(nombreArchivo);
                        break;
                    case 7:
                        //4. Buscar pelicula
                        System.out.println("INGRESE CANTIDAD A BUSCAR: Q.");
                        String buscar=scanner.nextLine();
                        catalogoPeli.buscar(nombreArchivo, buscar);
                        break;
                    case 8:
                        ...
                        switch(can){
                            case 1:
                                ...
                                catalogoPeli.editarNom(nombre,nuevo, nombreArchivo);
                            ...
                            case 2:
                                ...
                                catalogoPeli.editCantidad(cantidad, newcantidad, mesopc, nombreArchivo);
                                break;
                        }
                        break;
                    case 0:
